        ...
        <div>
            {employees.map(employee => (
                <div className="row d-flex align-items-center" key={employee.email}>
                    ...
                    <div className="col-1">{employee.name.first}</div>
                    <div className="col-1">{employee.name.last}</div>
                    <div className="col-2">{employee.dob.date.split("T")[0]}</div>
                    <div className="col-2">{employee.location.city}</div>
                    <div className="col-2">{employee.phone}</div>
